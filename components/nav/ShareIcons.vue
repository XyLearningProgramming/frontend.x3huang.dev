  ...
  <div class="flex flex-col gap-3">
    <template v-for="icon in icons" :key="icon.href">
      <a
        ...
        class="text-neo-black/70 hover:text-neo-black hover:scale-110 transition-all duration-200 flex items-center justify-center"
    ...
    >
      ...
      <svg v-else class="w-5 h-5 text-neo-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
