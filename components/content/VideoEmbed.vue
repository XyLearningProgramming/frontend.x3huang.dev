<template>
  <div class="video-embed-container">
    <div class="video-card-wrapper">
      <GlassCard variant="primary" class="video-card">
        <div class="video-content">
          <!-- Video Thumbnail or Player -->
          <div class="video-display">
            <!-- Thumbnail when not playing -->
            <div v-if="!isPlaying" class="video-thumbnail" @click="handlePlay(url)">
              <img
                :src="thumbnailUrl"
                :alt="title"
...
const thumbnailUrl = computed(() => {
  ...
  if (videoInfo.value.platform === 'Bilibili' && videoInfo.value.id) {
    // For Bilibili, we'll use a generic thumbnail since their API requires authentication
    // In a real implementation, you'd need to fetch this from Bilibili's API
